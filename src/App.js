...
// Column Component
const Column = ({ title, tickets, users, user }) => {
  const getIcon = () => {
    switch (title.toLowerCase()) {
      ...
      case 'yogesh':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-user-round">
    ...
    <div className="column">
      <div className="column-header">
        ...
        <div className="column-actions">
          <button className="icon-button"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
